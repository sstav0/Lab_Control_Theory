...
\begin{enumerate}
    ...
    Phase margin PM = 79.76042° at 0.01 rad/s
    \end{python*}
    Nous remarquons que $\alpha$ n'a peu (voire pas) sur les marges de stabilité. Ceci est dû au fait que $\alpha$ n'a d'influence que sur $T_{FD}$ qui est presque négligeable
